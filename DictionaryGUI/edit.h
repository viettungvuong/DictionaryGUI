...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Current word:";
			// 
			// label2
			// 
			...
			this->label3->Text = L"New definition:";
			// 
			// textBox1
			// 
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(264, 221);
			...
			this->ClientSize = System::Drawing::Size(363, 261);
